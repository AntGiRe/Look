<div>
    ...
    <div class="flex justify-center items-center mt-4">
        @if ($posts->hasMorePages())
            <button
                class="flex tracking-wide cursor-pointer px-8 py-2 font-bold text-sx text-white rounded-lg bg-slate-800 transition hover:bg-slate-700"
                ...
                <span class="ml-2">Cargar</span></button>
        @endif
    </div>
    <div x-data="{
        observe() {
